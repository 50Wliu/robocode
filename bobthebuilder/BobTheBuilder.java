...
public class BobTheBuilder extends AdvancedRobot
{
	...
	{
		// If the waves collection is empty, we must have missed the
	...
	private void move()
	{
		...
		switch(mode)
		{
			...
			case MODE_STRAFE:
			{
				...
				if(ThreadLocalRandom.current().nextInt(0, 21) == 0)
				{
					moveDirection *= -1;
				}
